...
<head>
    ...
    <link href="{{ secure_asset('sources/toastr/css/toastr.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ secure_asset('sources/dataTable/css/datatables.min.css') }}" rel="stylesheet" type="text/css">
...
<script src="{{ secure_asset('sources/toastr/js/toastr.min.js') }}"></script>
<script src="{{ secure_asset('sources/dataTable/js/datatables.min.js') }}"></script>
@yield('page_js')
@yield('scripts')
<script>
