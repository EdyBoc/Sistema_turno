                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <a class="btn btn-danger btn-lg" href="/index_catalogo"><i class="fas fa-reply"></i></i>Regrar</a> 
                                    <a class="btn btn-primary btn-lg" id="btn_actualizar"><i class="fas fa-history"></i> Actualizar</a>
                                    @can('crear')
                                    <a class="btn btn-primary btn-lg" href="{{ route('crear') }}">
                                        <i class="fas fa-street-view" >Nuevo Catalogo</i>
                                    </a>
                                    @endcan 
                                    <a class="btn btn-primary btn-lg" data-toggle="modal"
                                    data-target="#modal_add_items" ><i class="fas fa-street-view" ></i> Crear Catalogo Items</a>  
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <div class="input-group" >
                                    <input type="text" placeholder="Búsqueda Rápida" class="form-control" id="avanzado" name="avanzado">
                                    <div class="input-group-append">
                                        <button id="btnBuscar" class="btn btn-primary" type="button" data-toggle="tooltip" title="Buscar" >
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                {{ Form::select('id_renglon', @$estado, null, ['id' => 'id_renglon', 'class' => 'form-control ']) }}
                            </div>
                            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer justify-content-center">
                        <a id="btnCerrar" onclick="$('#modal_add_editar_catalogo').modal('hide');" class="btn btn-danger btn-lg"><i
                                class="fa fa-times"></i>&nbsp;Cancelar</a>
                        &nbsp;
                        <a href="#" id="btn_guardar_profesion" class="btn btn-warning btn-lg"><i
                            class="fas fa-plus-circle"></i>&nbsp;Guardar</a>
