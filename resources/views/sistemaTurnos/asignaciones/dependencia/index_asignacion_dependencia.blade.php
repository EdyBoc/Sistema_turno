...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Lista Asignacion Dependencia</h3>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::select('catalogo_dependencia', @$catalogo_dependencia, null, ['id' => 'id_catalogo_dependencia', 'class' => 'form-control', 'placeholder' => 'Seleccione...']) }}
                                </div>
                                ...
                                <table class="table table-sm" id="tabla_vacacion" cellspacing="0" style="font-size: 80%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-2" style="text-align: center;"> Dependencia</th>
                                            <th class="col-1" style="text-align: center;"> Fecha Asignado</th>
...
@section('scripts')
    <script>
        ...
        $("#btn_guardar_asignacion_dependencia").click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('guardar_asignacion_dependencia') }}",
                data: {
            ...
            $.get("{{ route('filtar_usuarios') }}", {
                ...
                function(response) {
                    ...
                    response.forEach(function(item) {
                        ...
                        fila += '<td style="text-align: center;">' + item.nombre_dependencia +
                            '</td>';
