...
class Codigo_ingreso extends Model
{
    use HasFactory;

    protected $table = 'codigo_ingreso'; // Nombre de la tabla en la base de datos
    protected $primaryKey = 'id_codigo_ingreso'; // Clave primaria de la tabla
