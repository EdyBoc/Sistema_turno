...
class catalogo_rol extends Model
{
    use HasFactory;

    protected $table = 'catalogo_rol'; // Nombre de la tabla en la base de datos
    protected $primaryKey = 'id_catalogo_rol'; // Clave primaria de la tabla
