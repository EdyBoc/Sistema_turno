...
--Esta tabla es funcional
    ...
    descripcion TEXT NOT NULL,
    fn_inicio datetime NOT NULL,
    fn_fin datetime NOT NULL,
    estado BOOLEAN NOT NULL DEFAULT true,
    user varchar(191),
    fn_ingreso datetime ,
    fn_ultima_modificacion datetime ,
...
--Esta tabla es funcional
    ...
    CREATE OR REPLACE VIEW vw_usuario_autorizados AS
        SELECT
            us.id,
            us.name,
            us.email,
        ...
        LEFT JOIN
            autorizacion aut ON scl.id_solicitud = aut.id_solicitud;
