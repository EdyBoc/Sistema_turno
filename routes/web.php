...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/guardar_dependencia_editado', [App\Http\Controllers\SistemaTurnos\CatalogoController::class, 'guardar_dependencia_editado'])->name('guardar_dependencia_editado');
    Route::post('/guardar_turno_editado', [App\Http\Controllers\SistemaTurnos\CatalogoController::class, 'guardar_turno_editado'])->name('guardar_turno_editado');
    //Catalogos Roles
    ...
    Route::post('/guardar_rol_editado', [App\Http\Controllers\SistemaTurnos\CatalogoRolController::class, 'guardar_rol_editado'])->name('guardar_rol_editado');
    //Vacaciones
    ...
    //Autorizaciones de
    Route::post('/guardar_solicitud_editado', [App\Http\Controllers\SistemaTurnos\AutorizacionController::class, 'guardar_solicitud_editado'])->name('guardar_solicitud_editado');
});
